		...
		<><a href="#">
          <img class="rounded-t-lg p-8" src={HeroImage} alt="product image" />
              ...
              <div class="flex items-center mt-2.5 mb-5">
                  ...
                  <span class="bg-blue-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-3">Fertilizer</span>
              </div>
              <div class="flex items-center justify-between">
                  <span class="text-2xl font-bold text-gray-900 dark:text-white">Lkr.7000</span>
                  <a href="#"
