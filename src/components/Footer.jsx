...
const Footer = () => {
  return (
    <div className='max-w-[1400px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 bg-yellow-300 text-black'>
      <div>
        <h1 className='w-full text-3xl font-bold text-black'>FOOTER.</h1>
