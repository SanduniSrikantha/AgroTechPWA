...
import F from '../assets/pesticide.webp'
...
const MyProduct1 = () => {
  ...
  return (
		...
		<><a href="#">
          <img class="rounded-t-lg p-8" src={F} alt="Product image" />
      </a><div class="px-5 pb-5">
              <a href="#">
                  <h3 class="text-gray-900 font-semibold text-xl tracking-tight dark:text-white">Farmers' Choice Pesticide, Kills all Insects</h3>
              </a>
              <div class="flex items-center mt-2.5 mb-5">
                  ...
                  <span class="bg-red-200 text-red-800  text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-3">Pesticide</span>
              </div>
