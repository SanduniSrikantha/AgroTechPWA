...
import P from '../assets/fertilizer123.jpg'
...
const MyProduct2 = () => {
  ...
  return (
		...
		<><a href="#">
          <img class="rounded-t-lg p-8" src={P} alt="Product image" />
      </a><div class="px-5 pb-5">
              <a href="#">
                  <h3 class="text-gray-900 font-semibold text-xl tracking-tight dark:text-white">Mega Humic Fertilizer, Crystal 90%</h3>
              </a>
