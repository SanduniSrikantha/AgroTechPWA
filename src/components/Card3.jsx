...
const Card3 = () => {
  return (
		...
		<><a href="#">
          <img class="rounded-t-lg p-8" src={PS} alt="product image" />
      </a><div class="px-5 pb-5">
              <a href="#">
                  <h3 class="text-gray-900 font-semibold text-xl tracking-tight dark:text-white">Premium Potato Seeds, Specially Selected for High Yields and Quality Crops</h3>
              </a>
